...
namespace VirtoCommerce.PricingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceEvaluationContext :  IEquatable<PriceEvaluationContext>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceEvaluationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PriceEvaluationContext);
        }

        /// <summary>
        /// Returns true if PriceEvaluationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of PriceEvaluationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceEvaluationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
