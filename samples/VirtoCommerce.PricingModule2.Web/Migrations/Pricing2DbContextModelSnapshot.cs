...
{
    [DbContext(typeof(Pricing2DbContext))]
    partial class Pricing2DbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.PricingModule.Data.Model.PriceEntity", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("PriceEntity");
            ...
            modelBuilder.Entity("VirtoCommerce.PricingModule2.Web.Entities.Price2Entity", b =>
                {
                    b.HasBaseType("VirtoCommerce.PricingModule.Data.Model.PriceEntity");

                    b.Property<decimal?>("RecommendedPrice")
                        .HasColumnType("Money");

                    b.HasDiscriminator().HasValue("Price2Entity");
                });
